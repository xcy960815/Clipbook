...
class Clipboard {
  ...
  func paste() {
    ...
    // See https://github.com/p0deje/Clipbook/issues/482 for details.
  ...
  func checkForChangesInPasteboard() { // swiftlint:disable:this cyclomatic_complexity
    ...
    // See https://github.com/p0deje/Clipbook/issues/241.
    ...
    // - https://github.com/p0deje/Clipbook/issues/78
    // - https://github.com/p0deje/Clipbook/issues/472
    ...
    pasteboard.pasteboardItems?.forEach({ item in
      ...
      // https://github.com/p0deje/Clipbook/issues/613
      // https://github.com/p0deje/Clipbook/issues/770
  ...
  // - Chrome Remote Desktop (https://github.com/p0deje/Clipbook/issues/948)
  // - Netbeans (https://github.com/p0deje/Clipbook/issues/879)
  private func sync() {
  ...
  private func clearFormatting(_ contents: [HistoryItemContent]) -> [HistoryItemContent] {
    ...
    if !stringContents.isEmpty {
      ...
      // Preserve file URLs.
      // https://github.com/p0deje/Clipbook/issues/962
